  ...
  return (
    <div className="mt-6 pb-6">
      <div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 text-gray-200 dark:text-gray-700">
          ...
          <div className="flex items-center sm:ml-4">
            ...
            Total Amount ${place.totalNights * place.place.price}
          </div>
        </div>
